...
20 Thorny Brae Dr.            & \textit{Phone:} (647) 523-7342 \\
Thornhill                     & \textit{Portfolio:} \href{http://yak.nu}{http://yak.nu}  \\
ON L3T3G3       & \textit{E-mail:}
...
\section{Skills} 
  \textbf{Tools:}                          Omnigraffle Pro, Photoshop CS4/CS5, Illustrator CS4/CS5, VIM.                          \\
  \textbf{Programming Languages:}          Ruby on Rails, C, Java, HTML, CSS, Javascript, git.       \\
  \textbf{Operating Systems:}              Developed for Microsoft Windows and Linux. Advanced OS X user.     \\
  \textbf{Languages:}                      English, Hebrew and Russian.                             \\
\end{document}
